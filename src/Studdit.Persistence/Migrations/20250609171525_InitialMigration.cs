        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reputation = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoteScore = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Vote_QuestionOrAnswer", "(QuestionId IS NOT NULL AND AnswerId IS NULL) OR (QuestionId IS NULL AND AnswerId IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answers_QuestionId_IsAccepted",
                table: "Answers",
                columns: new[] { "QuestionId", "IsAccepted" },
                filter: "IsAccepted = 1");

            migrationBuilder.CreateIndex(
                name: "IX_Answers_VoteScore",
                table: "Answers",
                column: "VoteScore");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_LastModifiedDate",
                table: "Votes",
